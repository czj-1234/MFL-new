# ============================================================
# Model: CLIP-ViT + RoBERTa for MVSA Score Regression
# ============================================================
...
class StrongMultimodalNet(nn.Module):
    """
    Strong multimodal model for MVSA sentiment score regression.
    ...
    Output:
        One continuous sentiment score.

    The regression score will later be mapped back to 6 classes:
        0 strong_negative
        1 weak_negative
        2 neutral_mixed
        3 weak_positive
    ...
    def __init__(
        ...
        num_classes=6,  # kept for old config compatibility, not used in regression output
        ...
        # Regression head:
        # original classification head was:
        #     nn.Linear(projector_hidden_dim, num_classes)
        #
        # regression version outputs one continuous sentiment score:
        #     shape = [batch_size, 1]
        self.regressor = nn.Linear(projector_hidden_dim, 1)
